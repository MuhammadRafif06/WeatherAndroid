...
import com.rafif.weatherappandroid.R
import com.rafif.weatherappandroid.WeatherResponse
import com.rafif.weatherappandroid.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun setupView(weather: WeatherResponse?, forecast: ForecastResponse?){
        binding.apply {
            weather?.let {
                ...
                setupBackgroundImage(it.weather?.get(0)?.id)
            }
    ...
    private fun setupBackgroundImage(idWeather: Int?) {
        idWeather?.let {
            when (idWeather) {
